            ...
            <ul>
                ...
                <li>
                    <div class="ad-hom-box ad-hom-box-3">
                        ...
                        <div class="ad-hom-view-com">
                        <p><i class="fa  fa-arrow-up up"></i> Total Service</p>
                        <h3>{{$serviceCount}}</h3>
                        </div>
                    </div>
                </li>
                <li>
                    <div class="ad-hom-box ad-hom-box-4">
                        ...
                        <div class="ad-hom-view-com">
                        <p><i class="fa  fa-arrow-up up"></i> Total Enquiry</p>
                        <h3>{{$enquiryCount}}</h3>
                        </div>
                    </div>
                </li>
            ...
            <div class="col-md-12">
                <div class="box-inn-sp">
                    <div class="inn-title">
                        ...
                        <p>All the recent Enquiries are here</p>
                        ...
                        <div class="table-responsive table-desi">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><a href="#"><span class="list-enq-name">Henry Hogan</span><span class="list-enq-city">Illunois, United States</span></a>
                                        </td>
                                        <td>+01 3214 6522</td>
                                        <td>chadengle@dummy.com</td>
                                        <td>Australia</td>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><span class="list-img"><img src="{{asset('admin-assets/images/listing/1.jpeg')}}" alt=""></span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="list-img"><img src="{{asset('admin-assets/images/listing/2.jpeg')}}" alt=""></span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="list-img"><img src="{{asset('admin-assets/images/listing/3.jpg')}}" alt=""></span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="list-img"><img src="{{asset('admin-assets/images/listing/4.jpeg')}}" alt=""></span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="list-img"><img src="{{asset('admin-assets/images/listing/5.jpg')}}" alt=""></span>
                                        </td>
                    ...
                    <div class="tab-inn">
                        <div class="table-responsive table-desi">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td><span class="list-img"><img src="{{asset('admin-assets/images/sm/1.png')}}" alt=""></span>
                                        </td>
                                    ...
                                    <tr>
                                        <td><span class="list-img"><img src="{{asset('admin-assets/images/sm/2.png')}}" alt=""></span>
                                        </td>
                                    ...
                                    <tr>
                                        <td><span class="list-img"><img src="{{asset('admin-assets/images/sm/3.png')}}" alt=""></span>
                                        </td>
                                    ...
                                    <tr>
                                        <td><span class="list-img"><img src="{{asset('admin-assets/images/sm/4.png')}}" alt=""></span>
                                        </td>
                                    ...
                                    <tr>
                                        <td><span class="list-img"><img src="{{asset('admin-assets/images/sm/5.png')}}" alt=""></span>
                                        </td>
                                    ...
                                    <tr>
                                        <td><span class="list-img"><img src="{{asset('admin-assets/images/sm/6.png')}}" alt=""></span>
                                        </td>
                                    ...
                                    <tr>
                                        <td><span class="list-img"><img src="{{asset('admin-assets/images/sm/7.png')}}" alt=""></span>
                                        </td>
