...
<div class="sb2-2">
    ...
    <div class="sb2-2-add-blog">
        <div class="box-inn-sp">
            <div class="inn-title">
                <h4>Add New Blog</h4>
                <p>Add New Blog to show in User Interface.</p>
            </div>
            <div class="bor">
                <form action="{{ route('blogs.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="blog-title" type="text" class="validate" name="title">
                    ...
                    {{-- <div class="input-field col s12">
                        <input id="blog-tags" type="text" class="validate" name="tags">
