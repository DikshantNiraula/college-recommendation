<h2>Best Path [ {{ round($result['total_distance'],3)}} KM]</h2>

@foreach ($result['route'] as $key => $college)

               <center>
                  {{-- <h5 class="color: #30890d; ">Travelled Distance:{{ round($result['distances'][$key],3)  ?? 0}}KM</h5> --}}
               </center>
